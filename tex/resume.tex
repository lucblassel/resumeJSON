...
\item{score: 15.58/20\quad - \quad\href{https://dauphine.psl.eu/formations/masters/informatique/m2-intelligence-artificielle-systemes-donnees}{More: \tiny{dauphine.psl.eu/formations/masters/informatique/m2-intelligence-artificielle-systemes-donnees}}
\end{cvitems}
}
...
\item{score: 15.58/20\quad - \quad\href{http://www.agroparistech.fr/ufr-info/iodaa/}{More: \tiny{agroparistech.fr/ufr-info/iodaa/}}
\end{cvitems}
}
...
\item{\href{https://en.wikipedia.org/wiki/Classe_preparatoire_aux_grandes_ecoles}{More: \tiny{en.wikipedia.org/wiki/Classe_preparatoire_aux_grandes_ecoles}}
\end{cvitems}
}
\end{cventries}
\cvsection{Languages}
